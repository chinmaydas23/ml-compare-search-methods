...
ax.set_title('COMPARISON OF SEARCH METHODS - DT REGRESSOR(R2 Scores)')
ax.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax)
plt.show()
plt.savefig('DTRegressorAvgScoresPlot.pdf')
...
ax2.set_title('COMPARISON OF SEARCH METHODS - DT REGRESSOR(Time of Execution)')
ax2.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax2)
plt.show()
plt.savefig('DTRegressorAvgTimesPlot.pdf')