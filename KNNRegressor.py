...
ax.set_title('COMPARISON OF SEARCH METHODS - KNN REGRESSOR(R2 Scores)')
ax.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax)
plt.show()
plt.savefig('KNNRegressorAvgScoresPlot.pdf')
...
ax2.set_title('COMPARISON OF SEARCH METHODS - KNN REGRESSOR(Time of Execution)')
