...
grid_search = GridSearchCV(model, DTCparams, cv = 3, scoring="r2", verbose=2, n_jobs=-1, error_score='raise')
random_search = RandomizedSearchCV(model, DTCparams, n_iter=10, cv=3, scoring="r2", verbose=2, n_jobs=-1)
bayes_search = BayesSearchCV(model, DTCparams, n_iter=10, cv=3, scoring="r2", verbose=2, n_jobs=-1)
