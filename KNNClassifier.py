...
labels = []
for classification_dataset in classification_dataset_names[:20]:
...
ax.set_title('COMPARISON OF SEARCH METHODS - KNN CLASSIFIER(Accuracy Scores)')
ax.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax)
plt.show()
plt.savefig('KNNClassifierAvgScoresPlot.pdf')
...
ax2.set_title('COMPARISON OF SEARCH METHODS - KNN CLASSIFIER(Time of Execution)')
ax2.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax2)
plt.show()
plt.savefig('KNNClassifierAvgTimesPlot.pdf')