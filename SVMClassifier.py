...
ax.set_title('COMPARISON OF SEARCH METHODS - SVM CLASSIFIER(Accuracy Scores)')
ax.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax)
plt.show()
# plt.savefig('SVMClassifierAvgScoresPlot.pdf')
...
ax2.set_title('COMPARISON OF SEARCH METHODS - SVM CLASSIFIER(Time of Execution)')
ax2.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax2)
plt.show()
# plt.savefig('SVMClassifierAvgPlotTest.pdf')