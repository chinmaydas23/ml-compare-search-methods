...
for classification_dataset in classification_dataset_names[1:25]:
...
ax.set_title('COMPARISON OF SEARCH METHODS - RF CLASSIFIER(Accuracy Scores)')
ax.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax)
plt.show()
plt.savefig('RFClassifierAvgScoresPlot.pdf')
...
ax2.set_title('COMPARISON OF SEARCH METHODS - RF CLASSIFIER(Time of Execution)')
ax2.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax2)
plt.show()
plt.savefig('RFClassifierAvgTimesPlot.pdf')
...
ax.set_title('COMPARISON OF SEARCH METHODS - RF REGRESSOR(R2 Scores)')
ax.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax)
plt.show()
plt.savefig('RFRegressorAvgScoresPlot.pdf')
...
ax2.set_title('COMPARISON OF SEARCH METHODS - RF REGRESSOR(Time of Execution)')
ax2.set_xticklabels(xlabels, rotation=0)
add_value_labels(ax2)
plt.show()
plt.savefig('RFReegressorAvgTimesPlot.pdf')